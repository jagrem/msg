...
namespace Msg.Core.Specs.Transport.Frames
{
    public class FrameSpecs
    {
        ...
        {
            // Act
            Action action = () => new Frame(new FrameHeader(new FrameSize(9), new DataOffset(2), FrameHeaderType.AMQP, new ChannelId(0)), new FrameExtendedHeader(new byte[0]), new FrameBody(new byte[0]));
        ...
        {
            // Act
            Action action = () => new Frame(new FrameHeader(new FrameSize(8), new DataOffset(3), FrameHeaderType.AMQP, new ChannelId(0)), new FrameExtendedHeader(new byte[0]), new FrameBody(new byte[0]));
        ...
        {
            // Act
            var frame = new Frame(new FrameHeader(new FrameSize(8), new DataOffset(2), FrameHeaderType.AMQP, new ChannelId(0)), new FrameExtendedHeader(new byte[0]), new FrameBody(new byte[0]));
