...
namespace Msg.Core.Specs.Transport.Frames
{
    ...
    {
        [Fact]
        public void Given_an_array_of_bytes_with_length_less_than_eight_When_creating_a_frame_header_from_a_byte_array_Then_throws_exception ()
        {
        ...
        [Fact]
        public void Given_an_array_of_bytes_with_length_more_than_eight_When_creating_a_frame_header_from_a_byte_array_Then_throws_exception ()
        {
        ...
        public void Given_a_size_field_of_100_When_creating_a_frame_header_from_a_byte_array_Then_the_size_equals_100 ()
        {
            ...
            var subject = FrameHeaderFactory.GetFrameHeaderFromBytes (bytes);
